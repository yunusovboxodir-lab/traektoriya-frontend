 ...
 *
 * 2026-07-02 (QA_ORCHESTRA блокер): supervisor и regional_manager исключены из
 * гейтинга. СВ и РМ — не стажёры «с нуля», а действующие руководители: им с
 * первого дня нужны team/tasks/products для управления полем (у 11 живых РМ
 * иначе то же «меню стажёра», что ловил СВ). День-1 онбординг
 * «Обучение → остальное по Мощи» — только для sales_rep.
 */
